  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Store Manager, your essential partner in ice cream business. Add products, manage pricing and control stock seamlessly for an effective operation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1564801629778-eabf6ed7d440?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpY2UlMjBjcmVhbSUyMHNob3B8ZW58MHx8fHwxNjk2ODU5ODY5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ksmetherman?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Katie Smetherman`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Store Manager, your essential partner in ice cream business. Add products, manage pricing and control stock seamlessly for an effective operation.`}
            </Text>
            <Box
