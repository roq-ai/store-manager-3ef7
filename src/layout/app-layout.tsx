...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'inventory-manager', 'store-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Stocks', path: '/stocks', entity: 'stock', service: AccessServiceEnum.PROJECT, icon: FiArchive },
    { name: 'Stores', path: '/stores', entity: 'store', service: AccessServiceEnum.PROJECT, icon: FiHome },
