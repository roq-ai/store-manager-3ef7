...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Product Addition.create': {
    ...
    key: 'product_addition',
    tenantPath: [],
    userPath: [],
  },
  'Product Sold Out.update': {
    roles: ['inventory-manager', 'business-owner'],
    key: 'product_sold_out',
    tenantPath: [],
    userPath: [],
  },
  'New Order.create': { roles: ['store-manager', 'business-owner'], key: 'new_order', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['business-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['inventory-manager', 'store-manager', 'business-owner'];
